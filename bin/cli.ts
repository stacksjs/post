...
cli
  ...
  .example('mail-server start --from localhost:5173 --to my-project.localhost')
  .example('mail-server start --from localhost:3000 --to my-project.localhost/api')
  .example('mail-server start --from localhost:3000 --to localhost:3001')
  .example('mail-server start --from localhost:5173 --to my-project.test --key-path /absolute/path/to/key --cert-path /absolute/path/to/cert')
